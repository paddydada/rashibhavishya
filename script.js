document.addEventListener("DOMContentLoaded", function () {
  ...
  //           rashiDropdown.options[i].text =
  //             rashiTranslations[language][rashiName];
  //         }
  //       }
  //       // Change rashi labels
  //       rashiLabels.forEach((label) => {
  //         label.textContent = "राशी चुनें :";
  //       });
  //       break;
  //     default:
  //       // Change rashi names in dropdown back to default
  //       for (let i = 0; i < rashiDropdown.options.length; i++) {
  //         const rashiName = rashiDropdown.options[i].value.split(".")[0];
  //         rashiDropdown.options[i].text =
  //           rashiName.charAt(0).toUpperCase() + rashiName.slice(1);
  //       }
  //       // Change rashi labels back to default
  //       rashiLabels.forEach((label) => {
  //         label.textContent = "Select Rashi :";
  //       });
  //   }
  // }
